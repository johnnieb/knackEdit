...
*/
     ...
     */
    Diff.prototype.match_main = function(text, pattern, loc) {
      // Check for null inputs.
     ...
     * @private
     */
    Diff.prototype.match_bitap_ = function(text, pattern, loc) {
     ...
     * @private
     */
    Diff.prototype.match_alphabet_ = function(pattern) {
      var s = {};
     ...
     * @param {!Diff.patch_obj} patch The patch to grow.
     * @param {string} text Source text.
     * @private
     */
    Diff.prototype.patch_addContext_ = function(patch, text) {
      if (text.length == 0) {
        return;
      }
     ...
     *
     * @param {string|!Array.<!Diff.Diff>} a text1 (methods 1,3,4) or
     * Array of diff tuples for text1 to text2 (method 2).
     * @param {string|!Array.<!Diff.Diff>} opt_b text2 (methods 1,4) or
     * Array of diff tuples for text1 to text2 (method 3) or undefined (method 2).
     * @param {string|!Array.<!Diff.Diff>} opt_c Array of diff tuples
     * for text1 to text2 (method 4) or undefined (methods 1,2,3).
     * @return {!Array.<!Diff.patch_obj>} Array of Patch objects.
     */
    Diff.prototype.patch_make = function(a, opt_b, opt_c) {
      var text1, diffs;
      if (typeof a == 'string' && typeof opt_b == 'string' &&
        ...
        diffs = /** @type {!Array.<!Diff.Diff>} */(a);
        text1 = this.diff_text1(diffs);
      } else if (typeof a == 'string' && opt_b && typeof opt_b == 'object' &&
          typeof opt_c == 'undefined') {
        // Method 3: text1, diffs
        text1 = /** @type {string} */(a);
        diffs = /** @type {!Array.<!Diff.Diff>} */(opt_b);
      } else if (typeof a == 'string' && typeof opt_b == 'string' &&
          opt_c && typeof opt_c == 'object') {
        // Method 4: text1, text2, diffs
        // text2 is not used.
        text1 = /** @type {string} */(a);
        diffs = /** @type {!Array.<!Diff.Diff>} */(opt_c);
      } else {
     ...
     * @param {!Array.<!Diff.patch_obj>} patches Array of Patch objects.
     * @return {!Array.<!Diff.patch_obj>} Array of Patch objects.
     */
    Diff.prototype.patch_deepCopy = function(patches) {
      // Making deep copies is hard in JavaScript.
      var patchesCopy = [];
      for (var x = 0; x < patches.length; x++) {
        var patch = patches[x];
        var patchCopy = new Diff.patch_obj();
        patchCopy.diffs = [];
     ...
     */
    Diff.prototype.patch_apply = function(patches, text) {
      if (patches.length == 0) {
        return [text, []];
      }
     ...
     */
    Diff.prototype.patch_addPadding = function(patches) {
     ...
     * @param {!Array.<!Diff.patch_obj>} patches Array of Patch objects.
     */
    Diff.prototype.patch_splitMax = function(patches) {
     ...
     */
    Diff.prototype.patch_toText = function(patches) {
      var text = [];
      for (var x = 0; x < patches.length; x++) {
        text[x] = patches[x];
      }
     ...
     */
/*
    Diff.prototype.patch_fromText = function(textline) {
      var patches = [];
      if (!textline) {
        return patches;
      }
...
*/
     ...
     * @constructor
     */
    Diff.patch_obj = function() {
      /** @type {!Array.<!Diff.Diff>} */
      this.diffs = [];
      /** @type {?number} */
      this.start1 = null;
      /** @type {?number} */
     ...
     */
    Diff.patch_obj.prototype.toString = function() {
      var coords1, coords2;
      if (this.length1 === 0) {
